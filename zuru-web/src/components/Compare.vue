          ...
          <div class="flex items-stretch">
            ...
            <div :class="[
              ...
              <div class="relative shrink-0">
                <img :src="championIconUrl(match.player1.campeon, ddragonVersion)" @error="championIconFallback"
            ...
            <div :class="[
              ...
              <div class="relative shrink-0">
                <img :src="championIconUrl(match.player2.campeon, ddragonVersion)" @error="championIconFallback"
                  class="w-12 h-12 rounded-lg" />
